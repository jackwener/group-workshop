...
| 编号 | 阶段 | 分类 | 文档名称 | 状态 |
|------|------|------|----------|------|
| `01` | Meta | 编号规范 | Spec 写作总则与文档编号索引（本文） | ✅ |
...
| 示例 | 对应 |
|------|------|
| `03-立项提案与范围说明.md` | Proposal |
| `09-API接口规格.md` | API Spec |
| `14-需求追踪矩阵.md` | Traceability |
...
| 轮次 | 文档 | 做什么 | 清晰度 |
|------|------|--------|--------|
| **1. 起点** | 02 → 03 → 04 | 采集需求 → 立项 → 产品需求 | 30% |
| **2. 锚定** | 05 + 09 | 用户故事与 API 接口互相校准 | 60% |
| **3. 展开** | 08 + 10 → 06 + 07 + 11 | 架构+数据+安全展开；06/07 被倒逼补全 | 85% |
