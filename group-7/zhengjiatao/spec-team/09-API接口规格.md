...
| 10 | `/api/v1/agent/reports/<id>` | DELETE | 删除研报 | 200 |
| 11 | `/api/v1/agent/reports/<id>/analyze` | POST | 分析研报 | 200 |
| 12 | `/api/v1/agent/health` | GET | 健康检查 | 200 |
| 13 | `/api/v1/agent/export` | POST | 导出问答记录 | 200 |
...
## 13. POST /reports/<id>/analyze — 分析研报
